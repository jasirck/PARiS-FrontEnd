...
function VisaCategory() {
  ...
  const fetchCategories = async () => {
    try {
      setLoading(true);
      const response = await axios.get("api/admin-visa-categories/", {
        headers,
      });
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`api/admin-visa-categories/${categoryToDelete}/`, {
        headers,
      });
      setCategories((prev) =>
    ...
    try {
      if (selectedCategory.id) {
        ...
        const response = await axios.patch(
          `api/admin-visa-categories/${selectedCategory.id}/`,
          selectedCategory,
          { headers }
        );
        setCategories((prev) =>
