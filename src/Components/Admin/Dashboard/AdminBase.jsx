...
//             <button
//               className={`w-full px-4 py-2 text-lg font-['Open_Sauce_One'] font-medium ${
...
//               <p className="text-sm font-['Open_Sauce_One'] font-medium text-gray-500">Services</p>
...
//             </div>
//             <div className="space-y-1">
//               <p className="text-sm font-['Open_Sauce_One'] font-medium text-gray-500">Requests</p>
//               {[
//                 "Holiday Request",
//                 "Packages Request",
//                 "Resort Request",
...
//               </svg>
//             </button>
//             <h1 className="text-xl lg:text-2xl font-['Open_Sauce_One'] font-bold text-gray-900">
//               {activeButton}
//             </h1>
//             <div
//               className="relative"
