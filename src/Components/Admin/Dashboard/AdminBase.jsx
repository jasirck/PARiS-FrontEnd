        ...
        <div className="p-4">
          ...
          <nav className="space-y-1">
            ...
            <Button
              ...
              onClick={() =>
                handleButtonClick("Visa Category", "/admin/visa-category")
              }
            >
              Visa Category
            </Button>
            <div className="space-y-1">
              ...
              <Button
                onClick={() => handleButtonClick("Packages", "/admin/packages")}
                className={`w-full px-4 py-2 text-lg font-medium text-left ${
            ...
            <div className="space-y-1">
              ...
              <Button
                onClick={() =>
                  handleButtonClick("Booked Packages", "/admin/booked-packages")
                }
                className={`w-full px-4 py-2 text-lg font-medium text-left ${
      ...
      <div className="flex-1 flex flex-col lg:ml-64 h-full">
        <header className="fixed top-0 left-0 right-0 bg-[#eaf1f4] shadow z-10 lg:left-64">
          <div className="flex items-center justify-between px-4 py-4 lg:px-6">
            {/* Left Section: Menu Toggle Button for Mobile */}
