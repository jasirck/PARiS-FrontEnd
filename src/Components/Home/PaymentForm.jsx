...
// export default function PaymentForm({ amount, name,adults,children,date,package_id }) {
//   const [loading, setLoading] = useState(false);
//   const [modalVisible, setModalVisible] = useState(true); // To toggle modal visibility

//   const handleSubmit = async (event) => {
//     event.preventDefault();
//     setLoading(true);
//    console.log(amount, name,adults,children,date,package_id);
...
//         { package_id,amount, name,adults,children,date, },
...
export default function PaymentForm({ amount, name,booked_id }) {
  const [loading, setLoading] = useState(false);
  const [modalVisible, setModalVisible] = useState(true); // To toggle modal visibility
