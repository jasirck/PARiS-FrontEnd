    ...
    >
      ...
      >
        ...
        <div className="p-6 md:p-8">
          ...
          >
            <button
              className="w-full sm:w-auto bg-gray-100 text-[#1E546F] px-6 py-3 rounded-full hover:bg-gray-200 transition-colors font-medium order-3 sm:order-1"
              onClick={onClose}
            >
              Close
            </button>
            <button
              className="w-full sm:w-auto bg-[#287094] text-white px-6 py-3 rounded-full hover:bg-[#1e5674] transition-colors font-medium flex items-center justify-center gap-2 order-2"
            ...
            <button
              className="w-full sm:w-auto bg-gradient-to-r from-[#287094] to-[#1e5674] text-white px-6 py-3 rounded-full hover:opacity-90 transition-opacity font-medium flex items-center justify-center gap-2 shadow-md order-1 sm:order-3"
