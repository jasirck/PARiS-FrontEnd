        ...
        {(onClose) => (
          <>
            <ModalHeader className="flex flex-col gap-1">
              <h2 className="text-xl font-bold text-[#023246]">
                Flight Details
              </h2>
            ...
            <ModalBody>
              ...
              <div className="mt-6 relative">
                ...
                <div className="flex mb-8 relative">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[#287094]">
                      {departure.time}
                    </p>
                    <p className="text-sm text-gray-600">{departure.full}</p>

                    <div className="mt-2">
                      <p className="font-medium text-[#023246]">
                ...
                <div className="flex mb-8 relative">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Distance: ~
                      {Math.floor(duration.hours * 800 + duration.minutes * 13)}{" "}
                      km
                    </p>
                  </div>
                </div>
                ...
                <div className="flex relative">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-sm text-gray-600">
                        Baggage Claim: {flight.arrival.baggage || "TBD"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Price Details */}
              <div>
                <h3 className="text-lg font-semibold text-[#023246] mb-4">
                  Price Details
                </h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span>
                      ₹{Math.floor(price * 0.85).toLocaleString("en-IN")}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#287094]">Taxes & Fees</span>
                    <span>
                      ₹{Math.floor(price * 0.15).toLocaleString("en-IN")}
                    </span>
                  </div>
                  <Divider className="my-2" />
                  <div className="flex justify-between font-bold">
                    <span className="text-[#023246]">Total Amount</span>
                    <span className="text-[#287094]">
                      ₹
              ...
              <div className="mt-6 bg-[#F6F6F6] p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-md font-semibold text-[#023246]">
                    Baggage Information
                  </h3>
                </div>
              ...
              {/* Important Notes */}
              <div className="mt-4">
                <h3 className="text-md font-semibold text-[#023246] mb-2">
                  Important Notes
                </h3>
                <ul className="space-y-1 text-sm text-[#287094]">
                  ...
                  <li className="flex items-start gap-2">
                    <IoCheckmarkCircle className="text-green-500 mt-1 flex-shrink-0" />
                    <span>
                      Web check-in available 48 hours to 60 minutes before
                      departure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Schedule and terminal information subject to change
                    </span>
                  </li>
                </ul>
              </div>
