...
function Holiday({ setIsModal }) {
  ...
  // Filter Holidays based on selected category
  ...
  // Sort Holidays based on selected order
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {loading ? (
          ...
          sortedHolidays.map((pkg, index) => (
            <div
              key={index}
              onClick={() => handleSelectHoliday(pkg.id)}
